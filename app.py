...
posts = [
    ...
    {"id": 2, "author": "Sinclair", "course": "Electrical system", "time": "5 hours ago", "text": "How do i use mesh analysis with capcitors involved?", "likes": 8, "comments": 0, "color": "purple", "comments_list": []},
    {"id": 3, "author": "John Engineering", "course": "Engineering", "time": "1 day ago", "text": "I don't need help, I'm just here to brag, HAHAHAHA", "likes": 67, "comments": 0, "color": "pink", "comments_list": []}
]
...
def forum():
    ...
    for post in posts:
        if "comments_list" not in post:
            post["comments_list"] = []
            post["comments"] = len(post["comments_list"])
